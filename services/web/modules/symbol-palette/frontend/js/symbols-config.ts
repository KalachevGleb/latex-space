...
export const SYMBOL_GROUPS: SymbolGroup[] = [
  {
    ...
    symbols: [
      ...
      { id: 'iint', label: '∬', command: '\\iint ' },
      { id: 'iiint', label: '∭', command: '\\iiint ' },
      { id: 'oint', label: '∮', command: '\\oint ' },
      { id: 'oiint', label: '∯', command: '\\oiint ' },
      { id: 'oiiint', label: '∰', command: '\\oiiint ' },
  ...
  },
  {
    ...
    symbols: [
      ...
      { id: 'epsilon', label: 'ϵ', command: '\\epsilon ' },
      { id: 'varepsilon', label: 'ε', command: '\\varepsilon ' },
      ...
      { id: 'phi', label: 'ϕ', command: '\\phi ' },
      { id: 'varphi', label: 'φ', command: '\\varphi ' },
