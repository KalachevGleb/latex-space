...
Для обновления:
1. Соберите новый пакет на машине разработки
2. Остановите текущую установку: `cd /opt/overleaf && docker compose down`
3. Установите новую версию с флагом `--no-start`
4. Запустите вручную: `docker compose up -d`

Данные сохраняются в `/opt/overleaf/data` и не затрагиваются при обновлении.
